...
public class SynchronizedArray<Element> {
    ...
    var asBaseType: [Element] {
        var copiedArray = [Element]()
        queue.sync { copiedArray = self.array }
        return copiedArray
    }
}
...
public extension SynchronizedArray {
    ...
    /// Returns and remove the last element of the collection.
    func popLast() -> Element? {
        var result: Element?
        queue.sync { result = self.array.popLast() }
        return result
    }
    ...
    func enumerated() -> EnumeratedSequence<Array<Element>> {
        var result: EnumeratedSequence<Array<Element>>!
