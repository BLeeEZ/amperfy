...
class LocalNotificationManager {
    ...
    init(userStatistics: UserStatistics) {
    ...
    func notify(podcastEpisode: PodcastEpisode) {
        ...
        do {
            ...
            let artworkUrl = createLocalUrl(forImage: podcastEpisode.image, fileIdentifier: fileIdentifier)
    ...
    private func createLocalUrl(forImage image: UIImage, fileIdentifier: String) -> URL {
        ...
        if imgData == nil {
            imgData = Artwork.defaultImage.pngData()
        }
