...
public class SearchAndPlayIntentHandler: NSObject, SearchAndPlayIntentHandling {
    ...
    public func resolveSearchTerm(for intent: SearchAndPlayIntent) async -> INStringResolutionResult {
        return INStringResolutionResult.success(with: intent.searchTerm ?? "")
    }
    
    @available(iOSApplicationExtension 13.0, *)
    public func resolveShuffleOption(for intent: SearchAndPlayIntent) async -> ShuffleTypeResolutionResult {
        return ShuffleTypeResolutionResult.success(with: intent.shuffleOption)
    }
    
    @available(iOSApplicationExtension 13.0, *)
    public func resolveRepeatOption(for intent: SearchAndPlayIntent) async -> RepeatTypeResolutionResult {
        return RepeatTypeResolutionResult.success(with: intent.repeatOption)
    }
    
    @available(iOSApplicationExtension 13.0, *)
    public func resolveSearchCategory(for intent: SearchAndPlayIntent) async -> PlayableContainerTypeResolutionResult {
        return PlayableContainerTypeResolutionResult.success(with: intent.searchCategory)
    }
...
public class PlayIDIntentHandler: NSObject, PlayIDIntentHandling {
    ...
    public func resolveId(for intent: PlayIDIntent) async -> INStringResolutionResult {
        return INStringResolutionResult.success(with: intent.id ?? "")
    }
    ...
    @available(iOSApplicationExtension 13.0, *)
    public func resolveLibraryElementType(for intent: PlayIDIntent) async -> PlayableContainerTypeResolutionResult {
        return PlayableContainerTypeResolutionResult.success(with: intent.libraryElementType)
    }
...
public class PlayRandomSongsIntentHandler: NSObject, PlayRandomSongsIntentHandling {
    ...
    public func resolveFilterOption(for intent: PlayRandomSongsIntent) async -> PlayRandomSongsFilterTypeResolutionResult {
        return .success(with: intent.filterOption)
    }
...
@MainActor public class PlayMediaIntentHandler: NSObject, @preconcurrency INPlayMediaIntentHandling {
    ...
    @available(iOS 13.0, *)
    public func resolveMediaItems(for intent: INPlayMediaIntent) async -> [INPlayMediaMediaItemResolutionResult] {
    ...
    @available(iOS 13.0, *)
    public func resolvePlayShuffled(for intent: INPlayMediaIntent) async -> INBooleanResolutionResult {
        return INBooleanResolutionResult.success(with: intent.playShuffled ?? false)
    }

    @available(iOS 13.0, *)
    public func resolvePlaybackRepeatMode(for intent: INPlayMediaIntent) async -> INPlaybackRepeatModeResolutionResult {
        return INPlaybackRepeatModeResolutionResult.success(with: intent.playbackRepeatMode)
    }
    
    @available(iOS 13.0, *)
    public func resolveResumePlayback(for intent: INPlayMediaIntent) async -> INBooleanResolutionResult {
        return INBooleanResolutionResult.success(with: intent.resumePlayback ?? true)
    }
    
    @available(iOS 13.0, *)
    public func resolvePlaybackQueueLocation(for intent: INPlayMediaIntent) async -> INPlaybackQueueLocationResolutionResult {
        return INPlaybackQueueLocationResolutionResult.success(with: intent.playbackQueueLocation)
    }

    @available(iOS 13.0, *)
    public func resolvePlaybackSpeed(for intent: INPlayMediaIntent) async -> INPlayMediaPlaybackSpeedResolutionResult {
        return INPlayMediaPlaybackSpeedResolutionResult.success(with: intent.playbackSpeed ?? 1.0)
    }
