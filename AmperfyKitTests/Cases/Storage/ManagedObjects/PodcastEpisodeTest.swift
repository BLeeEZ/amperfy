...
@MainActor class PodcastEpisodeTest: XCTestCase {
    ...
    func testCreation() {
        ...
        XCTAssertEqual(episode.image(theme: .blue, setting: .serverArtworkOnly), UIImage.getGeneratedArtwork(theme: .blue, artworkType: .podcastEpisode))
    ...
    func testArtworkAndImage() {
        let testData = UIImage.getGeneratedArtwork(theme: .blue, artworkType: .podcastEpisode).pngData()!
