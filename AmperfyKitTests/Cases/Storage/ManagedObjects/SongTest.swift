...
@MainActor class SongTest: XCTestCase {
    ...
    func testCreation() {
        ...
        XCTAssertEqual(song.image(theme: .blue, setting: .serverArtworkOnly), UIImage.getGeneratedArtwork(theme: .blue, artworkType: .song))
