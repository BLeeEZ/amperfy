...
public struct AmperfyImage: Sendable {
  ...
  public static let pin = Self("pin")
  public static let pinSlash = Self("pin.slash")
...
extension UIImage {
  ...
  public static let pin = UIImage.create(systemName: AmperfyImage.pin.systemName)
  public static let pinSlash = UIImage.create(systemName: AmperfyImage.pinSlash.systemName)
