...
public class LocalNotificationManager {
    ...
    public func notify(podcastEpisode: PodcastEpisode) {
        ...
        do {
            ...
            let artworkUrl = createLocalUrl(forImage: podcastEpisode.image(themeColor: storage.settings.themePreference.asColor, setting: storage.settings.artworkDisplayPreference), fileIdentifier: fileIdentifier)
