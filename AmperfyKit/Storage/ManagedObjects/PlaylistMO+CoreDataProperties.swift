...
extension PlaylistMO {
    ...
    @NSManaged public var artworkItems: Array<PlaylistItemMO>
...
extension PlaylistMO {
    ...
    @NSManaged public func insertIntoItems(_ value: PlaylistItemMO, at idx: Int)

    @objc(removeObjectFromItemsAtIndex:)
    @NSManaged public func removeFromItems(at idx: Int)

    @objc(insertItems:atIndexes:)
    @NSManaged public func insertIntoItems(_ values: [PlaylistItemMO], at indexes: NSIndexSet)

    @objc(removeItemsAtIndexes:)
    @NSManaged public func removeFromItems(at indexes: NSIndexSet)

    @objc(replaceObjectInItemsAtIndex:withObject:)
    @NSManaged public func replaceItems(at idx: Int, with value: PlaylistItemMO)

    @objc(replaceItemsAtIndexes:withItems:)
    @NSManaged public func replaceItems(at indexes: NSIndexSet, with values: [PlaylistItemMO])
...
extension PlaylistMO {
    ...
    @NSManaged public func insertIntoArtworkItems(_ value: PlaylistItemMO, at idx: Int)

    @objc(removeObjectFromArtworkItemsAtIndex:)
    @NSManaged public func removeFromArtworkItems(at idx: Int)

    @objc(insertArtworkItems:atIndexes:)
    @NSManaged public func insertIntoArtworkItems(_ values: [PlaylistItemMO], at indexes: NSIndexSet)

    @objc(removeArtworkItemsAtIndexes:)
    @NSManaged public func removeFromArtworkItems(at indexes: NSIndexSet)

    @objc(replaceObjectInArtworkItemsAtIndex:withObject:)
    @NSManaged public func replaceArtworkItems(at idx: Int, with value: PlaylistItemMO)

    @objc(replaceArtworkItemsAtIndexes:withArtworkItems:)
    @NSManaged public func replaceArtworkItems(at indexes: NSIndexSet, with values: [PlaylistItemMO])
    ...
    @NSManaged public func addToArtworkItems(_ values: NSOrderedSet)

    @objc(removeArtworkItems:)
    @NSManaged public func removeFromArtworkItems(_ values: NSOrderedSet)
